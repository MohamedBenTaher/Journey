        ...
        <Grid container className={classes.content}>
            <Grid item xs={12} md={12} lg={6} className={classes.Brand}>
                ...
                <Typography variant='body1' className={classes.text}>
                 ...
                 sometimes it's about running to what you truly want,here at journey we offer a great touring guide experience, with a large and supportive community
                </Typography>
            </Grid>
            <Grid item container xs={12} md={12} lg={6} className={classes.links}>
                <Grid item className={classes.About}  xs={12} md={12} lg={4} >
                    ...
                    <List className={classes.list}>
                        <ListItem className={classes.ListItem}>
                            <Link to='/' className={classes.link}> How to book</Link>
                        </ListItem>
                        <ListItem className={classes.ListItem}>
                            <Link to='/' className={classes.link}> Contact us</Link>
                        </ListItem>
                        <ListItem className={classes.ListItem}>
                            <Link to='/' className={classes.link}> Help Center</Link>
                        </ListItem>
                    </List>
                </Grid>
                ...
                <Typography variant='h6' className={classes.title}>Products</Typography>
                    <List className={classes.list}>
                        <ListItem className={classes.ListItem}>
                        <Link to='/' className={classes.link}>destination</Link>
                        </ListItem >
                        <ListItem className={classes.ListItem} >
                        <Link to='/' className={classes.link}>flight</Link>
                        </ListItem>
                        <ListItem className={classes.ListItem} >
                        <Link to='/' className={classes.link}>logding</Link>
                        </ListItem>
                    </List>
                </Grid>
                ...
                <Typography variant='h6' className={classes.title}>Social</Typography>
                    <List className={classes.list}>
                        <ListItem className={classes.ListItem}>
                            <Link to='/' className={classes.link}>Facebook</Link>    
                        </ListItem>
                        <ListItem className={classes.ListItem}>
