...
function Hero() {
  ...
  return (
    ...
    <Container className={classes.Devider} maxWidth={false} disableGutters>
      <Grid container  direction={{ xs: 'column', sm: 'column' ,md:'row',lg:'row'}} className={classes.deviderContent} spacing={4}> 
      ...
      <Grid item container>
        ...
        <Typography variant='body2'className={classes.body} >
          Join our community and discover more than 1000 destination, to the most beautiful places around the world,find hidden gems 
          rare locations and enjoy the best experience in your tours.
        </Typography>
      </Grid>
      </Grid>
      </Grid>
