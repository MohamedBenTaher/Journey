          ...
          <Grid item xs={12} md={6}>
            ...
            <Grid item>
              <Typography variant="body2" className={classes.body}>
                Join our community and discover more than 1000 destination, to the most beautiful
                places around the world,find hidden gems rare locations and enjoy the best
                experience in your tours.
              </Typography>
            </Grid>
          </Grid>
        </Grid>
