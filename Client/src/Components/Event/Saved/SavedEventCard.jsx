    ...
    <Card className={classes.smallCard}>
      ...
      <CardContent className={classes.content}>
        <Typography
          ...
          variant="h5"
          component="h2"
          className={event.coverImage ? classes.title : classes.noImageTitle}
        >
          {event.title}
        </Typography>
        <Typography
          variant="body2"
          component="p"
          className={!event.coverImage ? classes.noImageDesctiption : null}
        >
          {firstThreeLines}...
        </Typography>
        <Link to={`/events/${location._id}`}>
          <Button
            className={
              event.coverImage ? classes.button : classes.buttonNoImage
            }
          >
            Read More
          </Button>
