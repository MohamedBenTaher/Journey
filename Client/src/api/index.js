...
export const upVoteDestination = (destinationId, userId) => API.patch(`/destination/${destinationId}/upvote`, { userId });
export const downVoteDestination = (destinationId, userId) => API.patch(`/destination/${destinationId}/downvote`, { userId });
export const fetchDestinationsBySearch = (searchQuery) => API.get(
...
/*= ==================================Comments=============================================== */
/*= =============Destination============ */
export const commentEntity = (entityId, entityType, userId, content) => API.post(`/comment/${entityId}/comment`, {
    body: { userId, entityType, content },
  });
export const getEntityComments = (id, entityType) => API.get(`/comment/${id}`, { params: { entityType } });
export const updateEntityComments = (id, userId, content) => API.patch(`/comment/${id}`, { userId, content });
export const deleteEntityComments = (id) => API.delete(`/comment/${id}`);
/*= ====================================Images============================================ */
export const deleteS3Image = (id, srcUrl) => API.post(`/destination/image/delete/${id}`, { srcUrl });
/*= ====================================Country========================== */
...
export const fetchCountriesBySearch = (searchQuery) => API.get(
...
export const fetchContinentBySearch = (searchQuery) => API.get(
...
export const rateLocation = (locationId, userId, rating) => API.patch(`/location/${locationId}/rate`, { userId, rating });
export const fetchLocationsBySearch = (searchQuery) => API.get(
...
export const cancelBookmarkLocation = (id, userId) => API.patch(`location/${id}/cancel`, { userId });
/*= ============================Resources======================= */
